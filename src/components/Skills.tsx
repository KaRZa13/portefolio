        ...
        <div className='w-full h-full max-w-screen-xl max-h-screen grid grid-cols-4 gap-6 p-4 overflow-auto'>
          {skills.map((skill, index) => (
            ...
            <Tilt 
              ...
              before:w-8 before:h-8 before:border before:border-black before:absolute before:z-10 before:opacity-30 before:duration-500 before:top-6 before:right-6 before:border-b-0 before:border-l-0 
              ...
              after:w-8 after:h-8 after:border after:border-black after:absolute after:z-10 after:opacity-30 after:duration-500 after:bottom-6 after:left-6 after:border-t-0 after:border-r-0 '
            >
